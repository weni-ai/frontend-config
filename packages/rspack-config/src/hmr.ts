 ...
 *
 * Do not call this from store files. In development, the package Pinia HMR
 * loader injects `registerStoreHMR(useStore, import.meta.webpackHot)` for
 * every `export const … = defineStore(...)` under `src/store`.
 */
